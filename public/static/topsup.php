<div id="uploadDiv">
    <div class="row">
        ...
        <footer>
            <ul class="pagination">
                <li class="waves-effect"><a onclick="getNextForm('collup.php')"><i class="material-icons">keyboard_arrow_left</i></a></li>
                <li class="waves-effect"><a onclick="getNextForm('collup.php')">1</a></li>
                <li class="active"><a onclick="getNextForm('topsup.php')">2</a></li>
                ...
                <li class="waves-effect"><a onclick="getNextForm('bottomsup.php')"><i class="material-icons">keyboard_arrow_right</i></a></li>
            </ul>
        </footer>
    </div>
