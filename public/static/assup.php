<div id="uploadDiv">
    <div class="row">
        ...
        <footer>
            <ul class="pagination">
                <li class="waves-effect"><a onclick="getNextForm('shoesup.php')"><i class="material-icons">keyboard_arrow_left</i></a></li>
                ...
                <li class="active"><a onclick="getNextForm('assup.php')">5</a></li>
                <li class="disabled"><a href="#!"><i class="material-icons">keyboard_arrow_right</i></a></li>
            </ul>
        </footer>
